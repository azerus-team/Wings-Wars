...
execute if entity @s[type=player] if score input input matches 300..18000 run tellraw @a [{"text":"[","color":"gray","italic":true},{"selector":"@s"},": Deathmatch in ",{"score":{"name":"DeathmatchTime","objective":"Settings"}}," ticks","]"]