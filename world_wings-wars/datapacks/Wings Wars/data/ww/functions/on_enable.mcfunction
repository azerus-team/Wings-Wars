...
function ww:presets/classic
execute as @e[tag=FFA] at @s run function ww:settings/disable/ffa
...
execute as @e[tag=Spaceships] at @s run function ww:types/disable/spaceships
