...
execute if entity @s[type=player] if score input input matches 1..18000 run tellraw @a [{"text":"[","color":"gray","italic":true},{"selector":"@s"},": Bonuses appear in ",{"score":{"name":"BonusTime","objective":"Settings"}}," ticks","]"]