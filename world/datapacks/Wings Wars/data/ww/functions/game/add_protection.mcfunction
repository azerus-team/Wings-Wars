...
replaceitem entity @s[tag=protection1] armor.chest elytra{HideFlags:5,Unbreakable:1,Enchantments:[{id:"binding_curse",lvl:1},{id:"projectile_protection",lvl:2}],display:{Lore:['{"text":"Protection I","color":"gray","italic":"false"}']}} 1
execute if entity @s[tag=protection1] run tellraw @a [{"selector":"@s"},{"text":" has earned Protection I!","color":"aqua"}]
replaceitem entity @s[tag=protection2] armor.chest elytra{HideFlags:5,Unbreakable:1,Enchantments:[{id:"binding_curse",lvl:1},{id:"projectile_protection",lvl:4}],display:{Lore:['{"text":"Protection II","color":"gray","italic":"false"}']}}
execute if entity @s[tag=protection2] run tellraw @a [{"selector":"@s"},{"text":" has earned Protection II!","color":"aqua"}]
replaceitem entity @s[tag=protection3] armor.chest elytra{HideFlags:5,Unbreakable:1,Enchantments:[{id:"binding_curse",lvl:1},{id:"projectile_protection",lvl:5}],display:{Lore:['{"text":"Protection III","color":"gray","italic":"false"}']}}
execute if entity @s[tag=protection3] run tellraw @a [{"selector":"@s"},{"text":" has earned Protection III!","color":"aqua"}]
replaceitem entity @s[tag=protection4] armor.chest elytra{HideFlags:5,Unbreakable:1,Enchantments:[{id:"binding_curse",lvl:1},{id:"projectile_protection",lvl:5}],display:{Lore:['{"text":"Protection IV","color":"gray","italic":"false"}']}}
